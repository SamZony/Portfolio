...
<head>
    ...
    <!-- Customizable CSS -->
    <link rel="stylesheet" href="assets/css/main.css?a=124">
                        ...
                        <div id="hero" class="homepage-slider3">
                            <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                                <div class="full-width-slider">
                                    <div class="item"
                                        style="background-image: url(assets/images/sliders/makeup-cosmetics.webp?a=123);">
                                        <!-- /.container-fluid -->
                                    </div><!-- /.item -->
                                ...
                                <div class="full-width-slider">
                                    <div class="item full-width-slider"
                                        style="background-image: url(assets/images/sliders/abc.jpg?a=123);">
                                    </div><!-- /.item -->
                                </div><!-- /.full-width-slider -->
                ...
                <div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
                    <div class="more-info-tab clearfix">
                        ...
                        <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                            ...
                            <li><a href="#cosmatics" data-toggle="tab">Cosmatics</a></li>
                            <li><a href="#jewellery" data-toggle="tab">Jewellary</a></li>
                        </ul><!-- /.nav-tabs -->
                    </div>
...
?>
                        ...
                        <div class="tab-pane" id="cosmatics">
                            <div class="product-slider">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <section class="section">
                                <h3 class="section-title">Cosmatics</h3>
...
?>
                        ...
                        <div class="col-md-6">
                            <section class="section">
                                <h3 class="section-title">Arts & Stationary</h3>
                                <div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme"
                                    data-item="2">
                                    <?php
...
?>
                        ...
                        <div class="col-md-6">
                            <section class="section">
                                <h3 class="section-title">Handbags And Wallets</h3>
                                <div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme"
                                    data-item="2">
                                    <?php
...
?>
                        ...
                        <div class="col-md-6">
                            <section class="section">
                                <h3 class="section-title">Gift Articles</h3>
                                <div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme"
                                    data-item="2">
                                    <?php
...
?>
        ...
        <script src="assets/js/scripts.js?a=134"></script>
